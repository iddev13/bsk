...
// menuBtn.addEventListener('click', nullLink);
// function nullLink(e) {
//     e.preventDefault;
// }
...
//     document.querySelector('#menu').classList.toggle('header-burger-active');
// });


// document.querySelector('#menu-btn').addEventListener('click', menuHide) = menuHide;
...
const isoSkills = new Isotope(elemSkills, {
    // options
    itemSelector: '.skills__item',
    layoutMode: 'masonry',
